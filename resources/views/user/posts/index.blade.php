...
@section('containers')
    <div class="container-fluid d-flex align-items-center justify-content-between gap-1 mb-5">
        <h2 style="font-size:20px;" class="title" class="my-4 fw-bolder">Les publications</h2>
        <a href="{{route('user.posts.create')}}" class="btn btn-secondary">Créer une publication</a>
    </div>
